# ROADMAP archive — pre-GitHub-transition historical record (2026-07)

Archived 2026-07-07 as part of the repo-cleanup pass (issue #36).
Verbatim body moved out of `docs/ROADMAP.md` per its own header:
"Everything below this line is the PRE-TRANSITION historical record —
accurate as of 2026-07-07 morning, no longer maintained." Planning is
now GitHub-native (issues/milestones/labels); `docs/ROADMAP.md` is a
pointer only.
